...
from .OI import BUMPS_WHEEL_DROPS, BUTTONS, CHARGE_SOURCE, LIGHT_BUMPER, STASIS, WHEEL_OVERCURRENT
...
WheelOvercurrents = namedtuple('WheelOvercurrents',
                               'side_brush_overcurrent main_brush_overcurrent right_wheel_overcurrent left_wheel_overcurrent')
...
def decode_sensor_packets(data):
    """
